About notebook_intelligence-feedstock
=====================================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/notebook_intelligence-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/notebook_intelligence-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add notebook_intelligence
# for installing globally
pixi global install notebook_intelligence
```
...
It is possible to list all of the versions of `notebook_intelligence` available on your platform:
...
```
pixi search notebook_intelligence --channel conda-forge
```
